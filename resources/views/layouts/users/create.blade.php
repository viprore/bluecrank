...
@section('content')
    <form action="{{ route('users.store') }}" method="POST" role="form" class="form__auth">
        ...
        <div class="form-group">
            <a class="btn btn-default btn-lg" href="{{ route('social.login', ['naver']) }}">
                <strong>
                    N
                </strong>
            </a>
            <a class="btn btn-default btn-lg" href="{{ route('social.login', ['kakao']) }}">
                <i class="fa fa-commenting"></i>
            </a>
            <a class="btn btn-default btn-lg" href="{{ route('social.login', ['facebook']) }}">
                <i class="fa fa-facebook-square"></i>
            </a>
            <a class="btn btn-default btn-lg" href="{{ route('social.login', ['google']) }}">
